...
static const size_t GLFW_GAMEPAD_TO_KEYBOARD[GLFW_GAMEPAD_BUTTON_MAX] = {
    ...
    GLFW_KEY_KP_0, // GLFW_GAMEPAD_BUTTON_X
    GLFW_KEY_KP_DECIMAL, // GLFW_GAMEPAD_BUTTON_Y
    GLFW_KEY_KP_SUBTRACT, // GLFW_GAMEPAD_BUTTON_LEFT_BUMPER
    GLFW_KEY_KP_ADD, // GLFW_GAMEPAD_BUTTON_RIGHT_BUMPER
    GLFW_KEY_F1, // GLFW_GAMEPAD_BUTTON_BACK
    GLFW_KEY_F2, // GLFW_GAMEPAD_BUTTON_START
    GLFW_KEY_B, // GLFW_GAMEPAD_BUTTON_GUIDE
